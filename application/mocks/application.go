...
import (
	...
	application "github.com/pedroesteves2803/arquitetura-hexagonal/application"
)
...
// MockProductWhiter is a mock of ProductWhiter interface.
type MockProductWhiter struct {
	ctrl     *gomock.Controller
	recorder *MockProductWhiterMockRecorder
}

// MockProductWhiterMockRecorder is the mock recorder for MockProductWhiter.
type MockProductWhiterMockRecorder struct {
	mock *MockProductWhiter
}

// NewMockProductWhiter creates a new mock instance.
func NewMockProductWhiter(ctrl *gomock.Controller) *MockProductWhiter {
	mock := &MockProductWhiter{ctrl: ctrl}
	mock.recorder = &MockProductWhiterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductWhiter) EXPECT() *MockProductWhiterMockRecorder {
	return m.recorder
}

// Save mocks base method.
func (m *MockProductWhiter) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductWhiterMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductWhiter)(nil).Save), product)
}
